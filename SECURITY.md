...
5. Prefer logical memory-space keys for ordinary CLI/API/MCP operations instead of raw SQLite path overrides. Treat `--db` as an explicit admin or legacy escape hatch, not the default routing mechanism.

...
- **PRECISION-BIASED THRESHOLD DEFAULTS:** `recollectium dev optimize-threshold` now defaults to F0.5 when no beta is supplied, and the built-in FastEmbed thresholds were refreshed from the latest F0.5 evaluation results. Related PRs: [#117](https://github.com/AlfonsoDehesa/Recollectium/pull/117).
